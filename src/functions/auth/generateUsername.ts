...
/* ADOPTED FROM https://github.com/sindresorhus/crypto-random-string */
...
const generateForCustomCharacters = (length: any, characters: any) => {
...
const generateRandomBytes = (byteLength: any, type: any, length: any) =>
...
const createGenerator =
  (generateForCustomCharacters: any, generateRandomBytes: any) =>
  ({ length = 10, type = "url-safe", characters }: any) => {
...
export const generateUsername = createGenerator(
  generateForCustomCharacters,
  generateRandomBytes
);

(generateUsername as any).async = createGenerator(
